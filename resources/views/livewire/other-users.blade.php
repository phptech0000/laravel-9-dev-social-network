<div class="mt-8">
    <div class="mt-10">
        ...
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-white rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="search" type="text" placeholder="pesquisar...." wire:change="updateSearch($event.target.value)">
