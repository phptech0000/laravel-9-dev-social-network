<div wire:poll>
    ...
    <div class="p-2 flex justify-between  rounded bg-slate-100 shadow-md my-4">
        ...
        <div class="flex my-auto mx-4 space-x-5">
            ...
            <div wire:click="modalComment"><i class='far fa-comment-dots cursor-pointer ' style='font-size:24px'></i></div>
        </div>
    </div>
    @endforeach

    <div class="relative invisible z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <!--
