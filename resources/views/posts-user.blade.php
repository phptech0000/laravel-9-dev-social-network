                  ...
                  <div class="p-6 bg-white border-b border-gray-200">
                    <div class="grid gap-5">
                      ...
                      <div class="flex space-x-6">
                        <svg wire:click="addLikeToPost({{ $post->id }})" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6  @if ($post->userLikedPost()) text-blue-500 @endif">
